...
use service\resources\core\v1\cmsTree;
use service\resources\core\v1\config;
use tests\service\ApplicationTest;

class cmsTreeTest extends ApplicationTest
{
    ...
    {
        $this->assertInstanceOf('service\resources\core\v1\cmsTree', $this->model);
    }

    public function testGetConfigRequest()
    {
        $this->assertInstanceOf('service\message\core\CmsRequest', cmsTree::request());
    }

    public function testGetConfigResponseResponse()
    {
        $this->assertInstanceOf('service\message\core\CmsResponse', cmsTree::response());
    }
    ...
    public function testRun()
    {
        ...
        $this->header->setRoute('core.cmsTree');
