 ...
 * Time: 上午10:49
 */
class getCategoryTest extends ApplicationTest
{
    ...
    {
        $this->assertInstanceOf('service\message\core\getCategoryRequest', getCategory::request());
    }

    public function testResponse()
    {
        $this->assertInstanceOf('service\message\common\CategoryNode', getCategory::response());
    }
