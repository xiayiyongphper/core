...
class Wechat extends TenpayAbstract
{
    ...
    public function refund()
    {
        ...
        //$this->log($url);
        $cert = Mage::getModuleDir('data', 'LE_Tenpay') . DIRECTORY_SEPARATOR . '1226223001_20141223164400.pem';
        $ca = Mage::getModuleDir('data', 'LE_Tenpay') . DIRECTORY_SEPARATOR . 'tenpay_ca_cert.crt';
        $this->log($cert);
