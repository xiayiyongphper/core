...
class Combine extends ConditionAbstract
{
    ...
    public function asHtml()
    {
        $html = $this->getTypeElement()->getHtml() .
            sprintf('If %s of these conditions are %s:', $this->getAggregatorElement()->getHtml(), $this->getValueElement()->getHtml());
        if ($this->getId() != '1') {
